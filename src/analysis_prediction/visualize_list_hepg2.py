...
## This script uses boxplot to visualize the distributions of predicted HepG2 cytotoxicity scores of compounds in EPA/DrugBank lists 
...
## 0. Input arguments 
score_file	= 'data/compound_target_probability_tox21_prediction/rt-viability-hepg2-p1/dsstox_compound_target_fingerprint_maccs_probability_tox21-rt-viability-hepg2-p1_whole_data.tsv_rt_25_ps_5_re_0_xs_20_al_0.5_ld_0.0001_model_pred_by_list.tsv'
el_compare_file	= 'data/compound_target_probability_tox21_prediction/rt-viability-hepg2-p1/dsstox_compound_target_fingerprint_maccs_probability_tox21-rt-viability-hepg2-p1_whole_data.tsv_rt_25_ps_5_re_0_xs_20_al_0.5_ld_0.0001_model_pred_epa_list_compare_result_summary.tsv'
dl_compare_file	= 'data/compound_target_probability_tox21_prediction/rt-viability-hepg2-p1/dsstox_compound_target_fingerprint_maccs_probability_tox21-rt-viability-hepg2-p1_whole_data.tsv_rt_25_ps_5_re_0_xs_20_al_0.5_ld_0.0001_model_pred_drugbank_list_compare_result_summary.tsv'
plot_file	= 'plot/compound_target_probability_tox21_prediction/epa_list_tox21-rt-viability-hepg2-p1_dsstox_compound_model_pred_score_compare'	# folder name of output plof files 
list_name_dict	= {'tbutylphenols': 'butylphenols', 'wikiantifungals': 'antifungals', 'npinsect': 'insecticides', 'synthcannab': 'cannabinoids', 'wikirodenticides': 'rodenticides'}

## 1. Process input comparison and prediction data
# read in predicted HepG2 cytotoxicity scores of compounds in EPA/DrugBank lists 
...
# sort the lists by median of predicted HepG2 cytotoxicity scores
...
all_order = np.concatenate([['HepG2 +'], ecd_order, dcd_order, ['HepG2 -']]) 
...
score_df1.loc[score_df1.list_name == 'HepG2 +', 'predicted_cytotoxicity_score'] = np.nan
score_df1.loc[score_df1.list_name == 'HepG2 -', 'predicted_cytotoxicity_score'] = np.nan
# specify list name   
all_name = []
for ao in all_order:
...
## 2. Visualize distributions of predicted HepG2 cytotoxicity scores of compounds in EPA/DrugBank lists   
...
# make boxplot showing the distrubtion of predicted HepG2 cytotoxicity scores of compounds in EPA/DrugBank lists  
