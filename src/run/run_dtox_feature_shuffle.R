...
## This script generates shell scripts that run DTox model on feature-shuffled Tox21 datasets under Reactome pathway hierarchy
...
## 0. Input arguments
train_data_folder	<- "/home/yunhao1/project/TTox/data/compound_target_tox21_data/fingerprint_maccs_probability_feature_shuffle/";	# folder name of input feature-shuffled training-testing data files 
...
output_folder		<- "data/compound_target_probability_tox21_feature_shuffle/";	# folder name of output files 
N_cores			<- 3;	# number of CPUs
job_name		<- "dtox_compound_target_probability_tox21_feature_shuffle";	# job name
...
# list all input feature-shuffled training-testing data files  
